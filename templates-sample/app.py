...
@app.route("/for_list")
def show_for_list():
    item_list=[Item(1,"ダンゴ"),Item(2,"にくまん"),Item(3,"どら焼き")]
...
def show_filter_variable():
    ...
    kasa=Hero("笠地藏",43)
    #リストに詰める
    hero_list = [momo,kinta,ura,kasa,kagu]
    word = 'apple'
    return render_template('filter/filter_list.html',heroes = hero_list,showword=word)
